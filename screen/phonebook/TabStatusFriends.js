...
function TabStatusFriends() {
    return (
        <View style={{ justifyContent: 'flex-start', alignItems: 'center', height: 450 }}>
            <Text style={{ fontWeight: '600', marginTop: 80 }}>Cho Phép hiển thị trạng thái truy cập</Text>
            <Text style={{ color: "gray", marginVertical: 2 }}>Bạn cũng có thể thấy bạn bè truy cập. Bạn bè cũng</Text>
